...
>This is an face-to-face examination which must be completed in the allocated time and submitted to canvas. 
...
3. You agree to complete an oral assessment if requested to do so. 
...
# Before you begin
1. Create an R Project in the q-rap RS workspace called 'FIN7028-Mock-Exam'. Follow this url [invite](https://sso.posit.cloud/q-rap?redirect=https%3A%2F%2Fposit.cloud%2Fspaces%2F488697%2Fjoin%3Faccess_code%3DVUadBS0ooGYsyQiK6u7NeP39oJc10jWgp3IQlJ2G)
2. Make sure packages `ffp2,knitr,tsfe` are loaded by running `(.packages())` in console.

# Exam instructions

> 1. This exam is worth 50%.  
2. You will have two hours to answer a total of three questions. 
...
```
## Question 3
> In your own words write a reflective essay on your experience collaborating with GenAI for your analytics project? (35 marks)
