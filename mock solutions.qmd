...
The estimated parameters are: - $c = `r c`$ - $\phi_1 = `r p1`$ -
$\phi_2 = `r p2`$ - $\phi_3 = `r p3`$ - $\phi_4 = `r p4`$

Using these parameters and the last four observed values, we can
calculate the forecasts as follows:
